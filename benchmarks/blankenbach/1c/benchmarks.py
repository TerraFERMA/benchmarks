...
def extract():
  ...
  for n in ncells:
    ...
    qtl = -det["TemperatureGradient"]["TemperatureGradient"]["TopLeft"][-1][-1]
    qtr = -det["TemperatureGradient"]["TemperatureGradient"]["TopRight"][-1][-1]
    qbr = -det["TemperatureGradient"]["TemperatureGradient"]["BottomRight"][-1][-1]
    qbl = -det["TemperatureGradient"]["TemperatureGradient"]["BottomLeft"][-1][-1]
  ...
  table0.append("\hline\n")
  table0.append("Benchmark & 21.972 & 833.990 & 45.964 & 0.877 & 0.432 & 0.058 \\\\\n")
