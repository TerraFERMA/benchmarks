...
def extract():
  ...
  for n in ncells:
    ...
    table0.append("{0:2d}$\\times${0:2d} & {1:.3f} & {2:.3f} & {3:.3f} & {4:.3f} & {5:.3f} & {6:.3f} & {7:.3f} & {8:.3f} & {9:.3f} & {10:.3f} \\\\\n".format(n, nu, v_rms, q1, q2, q3, q4, Te1, ze1, Te2, ze2))
  ...
  table0.append("\hline\n")
  table0.append("Benchmark & 10.066 & 480.433 & 17.531 & 1.009 & 26.809 & 0.497 & 0.741 & 0.062 & 0.832 & 0.824 \\\\\n")
